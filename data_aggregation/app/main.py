...
async def main(file: str):
    ...
    tracks_tokens = client[config.DATABASE_NAME][config.TRACKS_TOKENS_COLLECTION_NAME]

    logger.info('start pipeline')

    async for doc in tracks_tokens.aggregate(pipelines.main_pipeline, allowDiskUse=True):
