from .base_pipeline import base_pipeline, filter_token_pos_base, filter_token_pos
...
main_pipeline = base_pipeline + [
    {'$facet': {
        'tokens_by_genre': filter_token_pos + tokens_by_genre,
        'tokens_by_genre_pos': filter_token_pos + tokens_by_genre_pos,
        'tokens_by_genre_year': filter_token_pos + tokens_by_genre_year,
